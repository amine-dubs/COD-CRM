...
Le mod\`{e}le utilise \textbf{21 features} regroup\'{e}es en 5 cat\'{e}gories :
...
\midrule
\multirow{3}{*}{\'{E}v\'{e}nements islamiques (5)} & ramadan, eid\_al\_fitr & P\'{e}riode de Ramadan, f\^{e}te de l'A\"{i}d el-Fitr (3j) \\
 & eid\_al\_adha, mawlid & F\^{e}te de l'A\"{i}d el-Adha (3j), Mawlid \\
 & islamic\_new\_year & Nouvel An islamique (1 Muharram) \\
\midrule
...
\begin{itemize}
  \item \textbf{Support natif des covariables} : Int\`{e}gre nativement 21 covariables (5 \'{e}v\'{e}nements islamiques + 1 jours f\'{e}ri\'{e}s nationaux + 5 features calendaires + 4 lags + 6 statistiques glissantes).
...
\begin{itemize}
  ...
  \item \textbf{Saisonnalit\'{e} locale} : Le calendrier alg\'{e}rien complet est int\'{e}gr\'{e} : \'{e}v\'{e}nements islamiques (Ramadan, A\"{i}d el-Fitr, A\"{i}d el-Adha, Mawlid, Nouvel An islamique) via \texttt{hijri-converter}, et jours f\'{e}ri\'{e}s nationaux (1\textsuperscript{er} janvier, Yennayer, 1\textsuperscript{er} mai, 5 juillet, 1\textsuperscript{er} novembre). Le feature \texttt{is\_weekend} couvre aussi tous les jours ch\^{o}m\'{e}s (vendredi-samedi + jours f\'{e}ri\'{e}s). Il reste \`{a} int\'{e}grer les \'{e}v\'{e}nements commerciaux (rentr\'{e}e scolaire, promotions) pour enrichir la couverture.
