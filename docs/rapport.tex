...
Le mod\`{e}le utilise \textbf{19 features} regroup\'{e}es en 4 cat\'{e}gories :
...
\multirow{3}{*}{Temporelles (5)} & day\_of\_week, month & Jour de la semaine, mois \\
 & is\_weekend & Indicateur week-end (0/1) \\
 & day\_of\_month, week\_of\_year & Jour du mois, semaine de l'ann\'{e}e \\
\midrule
\multirow{2}{*}{\'{E}v\'{e}nements islamiques (4)} & ramadan, eid\_al\_fitr & P\'{e}riode de Ramadan, f\^{e}te de l'A\"{i}d el-Fitr \\
 & eid\_al\_adha, mawlid & F\^{e}te de l'A\"{i}d el-Adha, Mawlid \\
\midrule
...
Les covariables du calendrier islamique sont calcul\'{e}es de mani\`{e}re programmatique via la biblioth\`{e}que \texttt{hijri-converter}, qui convertit les dates gr\'{e}goriennes en dates Hijri pour d\'{e}terminer automatiquement les p\'{e}riodes de Ramadan et des f\^{e}tes religieuses. Cette approche garantit l'exactitude des dates ind\'{e}pendamment de l'ann\'{e}e.
...
\begin{itemize}
  ...
  \item \textbf{Saisonnalit\'{e} locale} : Les \'{e}v\'{e}nements du calendrier islamique (Ramadan, A\"{i}d el-Fitr, A\"{i}d el-Adha, Mawlid) sont d\'{e}j\`{a} int\'{e}gr\'{e}s via le calendrier islamique programmatique (\texttt{hijri-converter}). Il reste \`{a} int\'{e}grer les \'{e}v\'{e}nements civils alg\'{e}riens (rentr\'{e}e scolaire, f\^{e}tes nationales) pour compl\'{e}ter la couverture.
